...
var SpriteAnimClass =
{
	...
	frameWidth:64, //the frame width will be the same width in the source image as the width of the displayed anim on the canvas (in pixels)
	frameHeight:64, //the frame height will be the same height in the source image as the height of the displayed anim on the canvas (in pixels)
	...
	//offset to the first frame of the anim. The frame index starts at the top left and works left to right / top to bottom.
	startFrame: 0,
	currentFrame : 0,
	numFrames: 0,
	frameRate: 128, //number of milliseconds between frame switches
	loop: true,
	isPlaying: false,
	visible: true,
	alpha: 1,
	...
	render: function(currContext)
	{
		...
		{
			currContext.save();
			currContext.translate(this.rect.x + this.rect.halfWidth, this.rect.y + this.rect.halfHeight);
			...
			currContext.drawImage(this.image, 
								...
								-this.rect.halfWidth,-this.rect.halfHeight,   //destination rect(x,y,width,height)
